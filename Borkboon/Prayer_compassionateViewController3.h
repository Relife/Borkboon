//
//  Prayer_compassionateViewController3.h
//  Borkboon
//
...
@interface Prayer_compassionateViewController3 : UIViewController<UITableViewDataSource,UITableViewDelegate,NSURLConnectionDelegate,UISearchBarDelegate>
{
